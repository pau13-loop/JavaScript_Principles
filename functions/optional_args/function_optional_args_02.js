...
largest = max();    // => 1 //! -Infinity
console.log(max(largest));

/**
 * TODO
 * Send more than one parameter to the function and access them by the position that the have inside the list of arguments instead of the parameter reference name. By this way we can send more than one parameter to functions that doesn't have specified how many parameters we can pass or even if we want to send more than the specified params of the function
 */