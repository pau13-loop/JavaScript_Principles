...
/**
 * TODO
 * I think will return the let variable calles "scope" with the value "local scope" because checksope returns the result of the execution of the function called f and the function f returns the local variable let called "scope"
 */