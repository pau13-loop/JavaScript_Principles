...
//* Define more than one property simultaneously for the specified obj
...
o.x = 3;
console.log("x writable false: " + o.x);    //* How we set the attribute "writeable" of "x" to false now we can not change the value of the prop "x"  

// si no es configurable no puedo cambiar a writable
// Object.defineProperty(o, "x",  { writable: true });     // error: cannot redefine property
...
//? Whyu we can not change the attributes of the prop I understand it but why before we could change the attribute "writeable"of "x" to false ???
