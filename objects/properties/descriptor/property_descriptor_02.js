...
console.log("Keys de x: ninguna " + Object.keys(o));        // => []  //* If the prop was enumerable this would return "x" like the key to allocate the prop inside the obj "o"
...
//* Returns {value: 1, writable: false, enumerable: false, configurable: true}
//* The props that we haven't indicated just get inherited the initial values assinged
...
//* We change the value manually accessing manually to it's configuration
...
//* By default when we create a property if we don't specify the attributes by default this ones are set to true 
