...
/**
 * TODO
 * With the inherit methods we can work above the obj in JS. 
 * 
 * isExtensible, will return true or false depending if the objet can be or not extense
 * 
 * preventExtensions, will not allow us to include new props inside the js obj
 * 
 * seal, will change all the attributes of the props of the obj to "configurable: false" 
 * 
 * freeze, will not allow to add any other property to the obj
 */