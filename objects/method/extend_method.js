...
//! Hard to understand at the moment but,
/**
 * TODO 
 * Extens an obj from another and inherit the properties from the other obj if the properties are not already defined in the obj whos inheriting the props, otherwise will skip the properties already defined in the obj. 
 * 
 //? What does "enumerable: false" ??? If you loop through the properties of the obj the one that has set the "enumerable to false" won't be included in the loop but still can be inherited
 */